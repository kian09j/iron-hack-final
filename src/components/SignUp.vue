<template>
  <div
    class="w-full bg-white dark:bg-slate-900 flex flex-col items-center justify-center min-h-screen p-4"
  >
    <h2 class="text-2xl font-bold mb-4 dark:text-white">Register</h2>
    <form @submit.prevent="handleRegister" class="space-y-6 max-w-sm w-full">
