  ...
  <div class="container mx-auto p-4">
    ...
    <div class="flex flex-wrap justify-around gap-4 mx-auto p-4">
      <div
        ...
        :key="task.id"
        class="bg-amber-100 p-6 rounded-lg shadow-lg w-full md:w-1/3 transform transition hover:scale-105"
      >
        ...
        <div class="flex mt-4 space-x-2">
          <button
            ...
            class="flex-1 bg-green-500 text-white px-4 py-2 rounded disabled:opacity-50 hover:bg-green-600"
          >
            Mark as Completed
          </button>
          <button
